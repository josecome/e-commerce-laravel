...
Route::post('/add_product',[ProdCategoriesController::class, 'addNewProduct']);
Route::post('/add_category',[ProdCategoriesController::class, 'addNewCategory'])->name('add_category');
