                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body" style='background-color: #D4E6F1;'>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button"
                                            @click="checkProduct($event, product_item.id, product_item.product)"
                                            class="btn btn-sm btn-outline-secondary" style="color: white;"
                                            :class="product_status[product_item.id] === 1 ? 'addToChrt' : 'rmvToChrt'">
                                            [[ product_status[product_item.id] !== null && product_status[product_item.id]
                                            === 1 ? 'Remove from Cart' : 'Add to Cart' ]]
                                        </button>
                                        <label class="btn btn-sm btn-outline-secondary">$[[ product_item.price ]]</label>
                                    </div>
                                    <div v-if="product_status[product_item.id] === 1" class="bi bi-cart-check Icn"
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="productModalLabel"><i
                                            class="bi bi-check-circle"></i>Successfull added to Cart</h5>
                                        ...
                                        <tr>
                                            <td>
                                                <img :src="['/storage/images/products/' + selected_image_link]"
                                                    :title="[selected_product]" style="width: 100%; height: 100%;" />
                                            </td>
                                            <td>
                                            ...
                                            <td colspan="2" style="text-align: center; display: flex;">
                                                <div v-for="product_related in list_of_products.slice(1, 4)">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <img :src="['/storage/images/products/' + product_related
                                                                    .image_link
                                                                ]"
                                                        ...
                                                        <tr>
                                                            <td><button
                                                                    @click="checkProduct($event, product_related.id, product_related.product)">Add
                                                                    to Cart</button></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr v-for="(product_item_in_cart, index) in Products_in_Cart"
                                                ...
                                                <td>
                                                    [[ format_to_money_style(product_item_in_cart.price *
                                                    product_item_in_cart.qnty) ]]
                                                </td>
                                                <td>
                                                    <i @click="Product_in_cart(product_item_in_cart.id, 'r')"
                                                        class="bi bi-x-octagon-fill"
                                                        style="float: right; padding-left: 6px; color: #E74C3C;"></i>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
            ...
            createApp({
                ...
                methods: {
                    ...
                    checkProduct: function(e, id, b) {
                        ...
                        chk === "Add to Cart" ? this.Product_in_cart(id, "p") : this.Product_in_cart(id,
                            "r") //p -> put in Cart and r -> remove from cart
